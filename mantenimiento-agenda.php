    ...
    if(isset($_POST['enviar']))
                {
                    ...
                    $query="SELECT max(id_evento)+1 as id_maximo from evento";
                    ...
                    while($mostrar=mysqli_fetch_array($resultado)){
                        ...
                        $target = "img/eventos/".$nombreImagen.".jpg";

                    $sql = "INSERT into evento (id_ministerio, nombre, descripcion,fecha)
                        VALUES (".$_POST["ministerio"].",'".$_POST["nombre"]."','".$_POST["descripcion"]."','".$_POST["fecha"]."')";
...
<body>
    ...
    <!-- Login Modal -->
            ...
            <form action="mantenimiento-agenda.php" method="POST" enctype="multipart/form-data">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body mx-3">
                    ...
                    <div class="md-form mb-4">
                      <input type="text" id="nombre" name="nombre" class="form-control validate" placeholder="Nombre del evento">
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Agenda</h2>
                        <p>Gestioná todos los eventos que se vienen. </p>
                    </div>
                    <table class="table table-striped">
                        ...
                        while($mostrar=mysqli_fetch_array($result)){
                        echo "<tr>";
                        echo "<td><p>".$mostrar['id_evento']."<p></td>";
                        ...
                        echo "<td><p class='btn btn-light'><a href=modificarevento.php?id_evento=".$mostrar['id_evento'].">Modificar</a><p></td>";
                        echo "<td><p class='btn btn-light' ><a href=validareliminacion.php?tabla=evento&id_evento=".$mostrar['id_evento'].">Eliminar</a><p></td>";
