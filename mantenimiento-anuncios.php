    ...
    if(isset($_POST['enviar']))
                {
                    ...
                    $query="SELECT max(id_anuncio)+1 as id_maximo from anuncio";
                    ...
                    while($mostrar=mysqli_fetch_array($resultado)){
                        ...
                        $target = "img/anuncios/".$nombreImagen.".jpg";


                    $sql = "INSERT into anuncio (id_miembro, titulo, anuncio,imagen)
                        VALUES ('".$_POST["miembro"]."','".$_POST["titulo"]."','".$_POST["anuncio"]."','$nombreImagen')";
...
<body>
    ...
    <!-- Login Modal -->
            ...
            <form action="mantenimiento-anuncios.php" method="POST" enctype="multipart/form-data">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Insertar anuncio</h4>
                  ...
                  <div class="modal-body mx-3">
                    ...
                    <h5>Miembro que publica</h5>
                    <select class="form-control validate" name="miembro" id="miembro">
                    <?php 
                        $conexion=mysqli_connect('localhost','root','root','IglesiaElLugar');
                        $sql="SELECT *,concat(nombre, ' ', apellido1) as nombreMiembro from persona where id_permiso=1 or id_permiso=2";
                    ...
                    <div class="md-form mb-4">
                      <input type="text" id="titulo" name="titulo" class="form-control validate" placeholder="Título del anuncio">
                    </div>

                    <div class="md-form mb-4">
                      <input type="text" id="anuncio" name="anuncio" class="form-control validate" placeholder="Descripción del anuncio">
                    </div>

                    <div class="md-form mb-4">
                        <h5>Agregue una imagen (opcional)</h5>
                      <input type="file" accept=".jpg" name="imagen" class="form-control validate">
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Anuncios</h2>
                        <p>Gestioná todos los anuncios. </p>
                    </div>
                    <table class="table table-striped">
                        <tr>
                            <td><h5>Código</h5></td>
                            <td><h5>Miembro que anuncia<h5></td>
                            <td><h5>Título<h5></td>
                            <td><h5>Anuncio<h5></td>
                            <td><h5>Foto<h5></td>
                        ...
                        <?php 
                        $conexion=mysqli_connect('localhost','root','root','IglesiaElLugar');
                        $sql="SELECT anuncio.*, concat(persona.nombre, ' ', persona.apellido1) as nombreMiembro FROM anuncio INNER JOIN persona ON anuncio.id_miembro = persona.cedula";
                        $result=mysqli_query($conexion,$sql);

                        while($mostrar=mysqli_fetch_array($result)){
                        echo "<tr>";
                        echo "<td><p>".$mostrar['id_anuncio']."<p></td>";
                        echo "<td><p>".$mostrar['nombreMiembro']."<p></td>";
                        echo "<td><p>".$mostrar['titulo']."<p></td>";
                        echo "<td><p>".$mostrar['anuncio']."<p></td>";
                        if (file_exists("img/anuncios/".$mostrar['id_anuncio'].".jpg")) {
                        	echo "<td><img src='img/anuncios/".$mostrar['id_anuncio'].".jpg' height='100%' width='100%'></td>";
                        }
                        else{
                        	echo "<td><p>No hay imagen para el anuncio</p></td>";
                        }
                        

                        echo "<td><p class='btn btn-light'><a href=modificaranuncio.php?id_anuncio=".$mostrar['id_anuncio'].">Modificar</a><p></td>";
                        echo "<td><p class='btn btn-light' ><a href=validareliminacion.php?tabla=anuncio&id_anuncio=".$mostrar['id_anuncio'].">Eliminar</a><p></td>";
