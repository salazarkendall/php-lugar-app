            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        <h2>¡Bienvenido al portal para administradores!</h2>
                        <p>Este módulo permite la gestión de datos importantes para la iglesia</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row about-content justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        <img src="img/bg-img/101.png" alt="">
                        <div class="about-text">
                            <h4>Mantenimiento</h4>
                            <p>Gestione los miembros, ministerios, mensajes, anuncios, entre otros.</p>
                            <a href="mantenimiento.php">Ir<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        <img src="img/bg-img/102.png" alt="">
                        <div class="about-text">
                            <h4>Financiero</h4>
                            <p>Lleve un control de las finanzas de la iglesia ordenadamente.</p>
                            <a href="financiero.php">Ir<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        <img src="img/bg-img/103.png" alt="">
                        <div class="about-text">
                            <h4>Reportes</h4>
                            <p>Infórmese con reportes de miembros actuales y personas interesadas.</p>
                            <a href="reportes.php">Ir<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        <img src="img/bg-img/104.png" alt="">
                        <div class="about-text">
                            <h4>Seguridad</h4>
                            <p>Gestione de manera segura el acceso de los miembros a la información.</p>
                            <a href="seguridad.php">Ir<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        <img src="img/bg-img/105.png" alt="">
                        <div class="about-text">
                            <h4>Ayuda</h4>
                            <p>Asistencia para uso del sistema</p>
                            <a href="ayuda.php">Ir<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
