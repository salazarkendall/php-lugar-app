    ...
    <section class="about-area section-padding-100-0">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        ...
                        <p>Lleve el orden de las finanzas y activos.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row about-content justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        ...
                        <div class="about-text">
                            <h4>Ofrenda</h4>
                            <a href="financiero-ofrenda.php">Gestionar<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        <img src="img/bg-img/113.jpg" alt="">
                        <div class="about-text">
                            <h4>Gasto</h4>
                            <a href="financiero-gasto.php">Gestionar<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        <img src="img/bg-img/114.jpg" alt="">
                        <div class="about-text">
                            <h4>Activo</h4>
                            <a href="financiero-activo.php">Gestionar<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        <img src="img/bg-img/115.jpg" alt="">
                        <div class="about-text">
                            <h4>Deuda</h4>
                            <a href="financiero-deuda.php">Gestionar<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        <img src="img/bg-img/116.jpg" alt="">
                        <div class="about-text">
                            <h4>Pago</h4>
                            <a href="financiero-pago.php">Gestionar<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
