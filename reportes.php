    ...
    <section class="about-area section-padding-100-0">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Reportes</h2>
                        <p>Listas con información útil a los administradores</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row about-content justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        ...
                        <div class="about-text">
                            <h4>Miembros</h4>
                            <p>Datos de los miembros actuales de la iglesia</p>
                            <a href="reportes-miembros.php">Ver<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        <img src="img/bg-img/117.jpg" alt="">
                        <div class="about-text">
                            <h4>Interesados</h4>
                            <p>Conozca las personas que han contactado la iglesia desde la sección "Contacto"</p>
                            <a href="reportes-personasinteresadas.php">Ver<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
