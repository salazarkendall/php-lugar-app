<?php
    ...
    if(isset($_GET['id']))
                {
                    $sql = "Update interesado set leido='1' where ID='".$_GET["id"]."'";
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        ...
                        <p>Gente que ha dejado su mensaje en el formulario de contacto y que desea más información. </p>
                    </div>
                    <table class="table table-striped">
                    <h4 align="center">Nuevos</h4>
                    <br>
                        <tr>
                            <td><h5>Nombre<h5></td>
                            <td><h5>Email<h5></td>
                        ...
                        $sql="SELECT * from interesado where leido='0'";
                        $result=mysqli_query($conexion,$sql);

                        while($mostrar=mysqli_fetch_array($result)){
                        echo "<tr>";
                        echo "<td><p>".$mostrar['nombre']."<p></td>";
                        echo "<td><p>".$mostrar['email']."<p></td>";
                        echo "<td><p>".$mostrar['telefono']."<p></td>";
                        echo "<td><p>".$mostrar['mensaje']."<p></td>";
                        echo "<td><p class='btn btn-light'><a href=reportes-personasinteresadas.php?id=".$mostrar['ID'].">Marcar como leído</a><p></td>";
                        echo "<td><p class='btn btn-light' ><a href=validareliminacion.php?tabla=interesado&id_interesado=".$mostrar['ID'].">Eliminar</a><p></td>";
                    ...
                    <br><br>
                    <table class="table table-striped">
                    <h4 align="center">Vistos anteriormente</h4>
                    <br>
                        <tr>
                            <td><h5>Nombre<h5></td>
                            <td><h5>Email<h5></td>
                        ...
                        <?php 
                        $conexion=mysqli_connect('localhost','root','root','IglesiaElLugar');
                        $sql="SELECT * from interesado where leido='1'";
                        $result=mysqli_query($conexion,$sql);
