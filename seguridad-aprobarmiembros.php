            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <table class="table table-striped">
                        ...
                        <?php 
                        $sql="SELECT *,concat(nombre, ' ', apellido1,' ',apellido2) as nombrecompleto from persona where id_permiso=3";
                        ...
                        echo "<td><p>".$mostrar['telefono2']."<p></td>";
                        echo "<td><p class='btn btn-light'><a href=aprobarmiembro.php?cedula=".$mostrar['cedula'].">Aprobar</a><p></td>";
                        echo "<td><p class='btn btn-light' ><a href=eliminarmiembro.php?cedula=".$mostrar['cedula'].">Eliminar</a><p></td>";
