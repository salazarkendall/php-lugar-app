    ...
    if(isset($_POST['enviar']))
                {
                    ...
                    $sql = "INSERT into ministerio (id_director, nombre, descripcion)
                        VALUES ('".$_POST["director"]."','".$_POST["nombre"]."','".$_POST["descripcion"]."')";

                    $result = mysqli_query($conn,$sql);
                    $message = 'Ministerio agregado';
...
<body>
    ...
    <!-- Login Modal -->
            ...
            <form action="mantenimiento-ministerios.php" method="POST">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Insertar ministerio</h4>
                  ...
                  <div class="modal-body mx-3">
                    ...
                    <h5>Director del ministerio:</h5>
                    <select class="form-control validate" name="director" id="director">
                    <?php 
                    ...
                    <div class="md-form mb-4">
                      <input type="text" id="nombre" name="nombre" class="form-control validate" placeholder="Nombre del ministerio">
                    </div>

                    <div class="md-form mb-4">
                      <input type="text" id="descripcion" name="descripcion" class="form-control validate" placeholder="Descripción">
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Ministerio</h2>
                        <p>Gestioná cada uno de los ministerios. </p>
                    </div>
                    <table class="table table-striped">
                        ...
                        <?php 
                        $conexion=mysqli_connect('localhost','root','root','IglesiaElLugar');
                        $sql="SELECT ministerio.*, concat(persona.nombre, ' ', persona.apellido1) as nombreDirector FROM ministerio INNER JOIN persona ON ministerio.id_director = persona.cedula";
                        $result=mysqli_query($conexion,$sql);

                        while($mostrar=mysqli_fetch_array($result)){
                        echo "<tr>";
                        echo "<td><p>".$mostrar['id_ministerio']."<p></td>";
                        echo "<td><p>".$mostrar['nombreDirector']."<p></td>";
                        echo "<td><p>".$mostrar['nombre']."<p></td>";
                        echo "<td><p>".$mostrar['descripcion']."<p></td>";
                        echo "<td><p class='btn btn-light'><a href=modificarministerio.php?id_ministerio=".$mostrar['id_ministerio'].">Modificar</a><p></td>";
                        echo "<td><p class='btn btn-light' ><a href=validareliminacion.php?tabla=ministerio&id_ministerio=".$mostrar['id_ministerio'].">Eliminar</a><p></td>";
