...
require 'logica/conexion.php';           
    ...
    if(isset($_POST['enviar']))
                {
                    $sql = "Update persona set nombre='".$_POST["nombre"]."', id_permiso=1, apellido1='".$_POST["apellido1"]."',apellido2='".$_POST["apellido2"]."',genero='".$_POST["genero"]."',telefono1='".$_POST["telefono1"]."',telefono2='".$_POST["telefono2"]."',email='".$_POST["email"]."',direccion='".$_POST["direccion"]."',fecha_nacimiento='".$_POST["fecha_nacimiento"]."' where cedula='".$_POST["cedula"]."'";
                    ...
                    echo "<SCRIPT type='text/javascript'> //not showing me this
                            alert('$message');
                    window.location.replace(\"ayuda-editarperfil.php?email=".$_POST["email"]."\");
                    </SCRIPT>";
                }
        mysqli_close($conn);                       
?>
...
<body>
    ...
    <?php 
            $conexion=mysqli_connect('localhost','root','root','IglesiaElLugar');
                        $sql="SELECT *,concat(nombre, ' ', apellido1,' ',apellido2) as nombrecompleto from persona where email='$emailSesion'";
                        $result=mysqli_query($conexion,$sql);

                        while($mostrar=mysqli_fetch_array($result)){
                            ?>
            <div>
            <form action="ayuda-editarperfil.php" method="POST">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Editar mi perfil</h4>
                  </div>
                  <div class="modal-body mx-3">
                    ...
                    <div class="md-form mb-4">
                      <?php echo "<input type='text' id='direccion' name='direccion' class='form-control validate' placeholder='Direccion' value='".$mostrar['direccion']."'>";?>
                    </div>
                  ...
                  <div class="modal-footer d-flex justify-content-center">
                    ...
                    <div class="modal-footer d-flex justify-content-center">
                        <a href="cambiocontrasena.php?email=<?php echo $emailSesion;?>" class="tn crose-btn btn-2">Cambiar Contraseña</a>
                    </div>
                    <div class="modal-footer d-flex justify-content-center">
                        <a href="desactivarmicuenta.php?email=<?php echo $emailSesion;?>" class="tn crose-btn btn-2">Cerrar mi cuenta</a>
                    </div>
                </div>
              </div>
              </form>
