    ...
    if(isset($_POST['enviar']))
                {
                    ...
                    $sql = "INSERT into gasto (nombre, monto, moneda, fecha, id_miembro, comentario)
                        VALUES ('".$_POST["nombre"]."',".$_POST["monto"].",'".$_POST["moneda"]."','".$_POST["fecha"]."','".$_POST["miembro"]."','".$_POST["comentario"]."')";
                    ...
                    echo "<SCRIPT type='text/javascript'> //not showing me this
                            alert('$message');
                    window.location.replace(\"financiero-gasto.php\");
                    </SCRIPT>";
                }
        mysqli_close($conn);                       
?>
...
<body>
    ...
    <!-- Insertar Modal -->
            ...
            <form action="financiero-gasto.php" method="POST">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Registrar gasto</h4>
                  ...
                  <div class="modal-body mx-3">
                    ...
                    <div class="md-form mb-4">
                      <input type="text" id="nombre" name="nombre" class="form-control validate" placeholder="Nombre del gasto">
                    </div>

                    <div class="md-form mb-4">
                      <input type="number" id="monto" name="monto" class="form-control validate" placeholder="Monto">
                    </div>
                    ...
                    <div class="md-form mb-4">
                        <h5>Fecha</h5>
                      <input type="Date" id="fecha" name="fecha" class="form-control validate" placeholder="Fecha">
                    </div>
                    ...
                    <?php 
                     ...
                     <div class="md-form mb-4">
                      <input type="text" id="comentario" name="comentario" class="form-control validate" value="" placeholder="Comentario adicional">
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Gastos</h2>
                        <p>Tenga visibilidad de los gastos que la iglesia ha tenido que pagar</p>
                    </div>
                    <table class="table table-striped">
                        <tr>
                            ...
                            <td><h5>Moneda<h5></td>
                            <td><h5>Fecha<h5></td>
                            <td><h5>Comentario adicional<h5></td>  
                            <td><h5>Miembro que registró<h5></td>  
                        </tr>

                        <?php 
                        $sql="SELECT gasto.*,concat(persona.nombre, ' ', persona.apellido1,' ',persona.apellido2) as nombrecompleto from gasto inner join persona on gasto.id_miembro=persona.cedula";
                        $result=mysqli_query($conexion,$sql);

                        while($mostrar=mysqli_fetch_array($result)){
                        echo "<tr>";
                        echo "<td><p>".$mostrar['nombre']."<p></td>";
                        echo "<td><p>".number_format($mostrar["monto"])."<p></td>";
                        echo "<td><p>".$mostrar['moneda']."<p></td>";
                        echo "<td><p>".$mostrar['fecha']."<p></td>";
                        echo "<td><p>".$mostrar['comentario']."<p></td>";
