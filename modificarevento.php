    ...
    if(isset($_POST['enviar']))
                {
                    ...
                    $sql = "Update evento set id_ministerio='".$_POST["ministerio"]."', nombre='".$_POST["nombre"]."',descripcion='".$_POST["descripcion"]."',fecha='".$_POST["fecha"]."' where id_evento='".$_POST["id_evento"]."'";
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body mx-3">
                    ...
                    <div class="md-form mb-4">
                        <?php echo "<input type='text' id='id_evento' name='id_evento' class='form-control validate' placeholder='Código' value='".$mostrar['id_evento']."' readonly>";?>
                    </div>
                    ...
                    <div class="md-form mb-4">
                        <?php echo "<input type='text' id='nombre' name='nombre' class='form-control validate' placeholder='Título del evento' value='".$mostrar['nombre']."'>";?>
                    </div>
                    ...
                    if (file_exists("img/eventos/".$mostrar['id_evento'].".jpg")) {
                            echo "<h5>Imagen Actual</h5><div class='md-form mb-4'><img src='img/eventos/".$mostrar['id_evento'].".jpg' height='400' width='400'></div>";
                        }
                        else{
