    ...
    if(isset($_POST['enviar']))
                {
                    ...
                    $query="SELECT max(id_producto)+1 as id_maximo from producto";
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Insertar producto</h4>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Productos</h2>
                        <p>Gestioná todos los productos</p>
                    </div>
                    <table class="table table-striped">
                        ...
                        <?php 
                        $conexion=mysqli_connect('localhost','root','root','IglesiaElLugar');
                        $sql="SELECT producto.*, concat(persona.nombre, ' ', persona.apellido1) as nombreMiembro FROM producto INNER JOIN persona ON anuncio.id_miembro = persona.cedula";
                        $result=mysqli_query($conexion,$sql);
                        ...
                        if (file_exists("img/productos/".$mostrar['id_producto'].".jpg")) {
                        	echo "<td><img src='img/productos/".$mostrar['id_producto'].".jpg' height='100%' width='100%'></td>";
                        }
                        else{
                        	echo "<td><p>No hay imagen para el producto</p></td>";
                        }
                        

                        echo "<td><p class='btn btn-light'><a href=modificarproducto.php?id_producto=".$mostrar['id_producto'].">Modificar</a><p></td>";
                        echo "<td><p class='btn btn-light' ><a href=validareliminacion.php?tabla=producto&id_producto=".$mostrar['id_producto'].">Eliminar</a><p></td>";
