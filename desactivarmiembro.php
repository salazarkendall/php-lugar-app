              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body mx-3">
                    <p align="center">Esta acción eliminará al usuario de la lista de miembros de la iglesia. Si lo considera pertinente, agregue un comentario. Esta persona aparecerá en la lista de ex-miembros en Mantenimiento > Miembros</p>

                    <div class="md-form mb-4">
                        <?php echo "<input type='text' id='cedulaDesactivar' name='cedulaDesactivar' class='form-control validate' placeholder='Cédula' value='$cedula' readonly>";?>
                    </div>
