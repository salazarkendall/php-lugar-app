...
<head>
    ...
    <!-- Title -->
    <title>Iglesia El Lugar | Seguridad</title>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        ...
                        <p>Lista de los permisos presentes en el sistema. El administrador puede cambiar desde Mantenimiento > Miembros los permisos de los miembros. Si una visita desea solicitar una cuenta de miembro debe crear una solicitud desde la página web.</p>
                    </div>
                    <table class="table table-striped">
                        <tr>
                            <td><h5>Código</h5></td>
                            <td><h5>Descripción<h5></td>
                            <td><h5>Permisos<h5></td>   
                        </tr>
                        <tr>
                            <td><p>1</p></td>
                            <td><p>Administrador</p></td>
                            <td><p data-toggle="tooltip" data-placement="top"><i class="fa fa-check" aria-hidden="true"></i> Acceso a página web</p>
                            <p data-toggle="tooltip" data-placement="top"><i class="fa fa-check" aria-hidden="true"></i> Sus datos están en el directorio de miembros de la iglesia</p><p data-toggle="tooltip" data-placement="top"><i class="fa fa-check" aria-hidden="true"></i> Se pueden asignar eventos a su nombre, mostrando sus datos de contacto por si hay interesados.</p><p data-toggle="tooltip" data-placement="top"><i class="fa fa-check" aria-hidden="true"></i> Puede gestionar miembros, mensajes, anuncios, eventos, ministerios y reportes de ministerio.</p><p data-toggle="tooltip" data-placement="top"><i class="fa fa-check" aria-hidden="true"></i> Puede gestionar datos financieros.</p></td>   
                        </tr>
                        <tr>
                            <td><p>2</p></td>
                            <td><p>Miembro regular</p></td>
                            <td><p data-toggle="tooltip" data-placement="top"><i class="fa fa-check" aria-hidden="true"></i> Acceso a página web</p>
                            <p data-toggle="tooltip" data-placement="top"><i class="fa fa-check" aria-hidden="true"></i> Sus datos están en el directorio de miembros de la iglesia</p><p data-toggle="tooltip" data-placement="top"><i class="fa fa-check" aria-hidden="true"></i> Se pueden asignar eventos a su nombre, mostrando sus datos de contacto por si hay interesados.</p></td>   
                        </tr>
                        <tr>
                            <td><p>3</p></td>
                            <td><p>Visita</p></td>
                            <td><p data-toggle="tooltip" data-placement="top"><i class="fa fa-check" aria-hidden="true"></i> Acceso a página web</p></td>   
                        </tr>
                    </table>
