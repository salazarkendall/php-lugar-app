...
$cedula = $_GET['cedula']; 
$cedulaActivar = $_POST['cedulaActivar'];
$comentario_adicional = $_POST['comentario_adicional']; 
    ...
    if(isset($_POST['enviar']))
                {
                        $sql = "Update persona set estado='activo', comentario_adicional='$comentario_adicional', id_permiso=2 where cedula='$cedulaActivar'";

                        $result = mysqli_query($conn,$sql);
                        


                        $message = 'Miembro habilitado nuevamente';
...
<head>
    ...
    <!-- Title -->
    <title>Iglesia El Lugar | Activar Miembro</title>
...
<body>
    ...
    <!-- Login form -->
            <div>
            <form action="activarmiembro.php?" method="POST">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Habilitar usuario</h4>
                  </div>
                  <div class="modal-body mx-3">
                    <p align="center">Esta acción habilitará al usuario nuevamente. La persona volverá a aparecer en la lista de miembros en Mantenimiento > Miembros como un miembro regular</p>

                    <div class="md-form mb-4">
                        <?php echo "<input type='text' id='cedulaActivar' name='cedulaActivar' class='form-control validate' placeholder='Cédula' value='$cedula' readonly>";?>
                    </div>
