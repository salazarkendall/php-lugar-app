    ...
    if(isset($_POST['enviar']))
                {
                    if ($contrasena==$confirmarContrasena) {
                        $sql = "Update persona set contrasena='$contrasena' where email='$emailUsuario'";
...
<head>
    ...
    <!-- Title -->
    <title>Iglesia El Lugar | Cambio de contraseña</title>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body mx-3">
                    <p align="center">Por favor digite lo que se solicita para proceder al cambio de contraseña</p>

                    <div class="md-form mb-4">
                        <?php echo "<input type='text' id='email' name='email' class='form-control validate' placeholder='Email' value='$email' readonly>";?>
                    </div>

                    <div class="md-form mb-4">
                        <input type="password" id="contrasena" name="contrasena" class="form-control validate" placeholder="Contraseña" value="" >
                    </div>

                    <div class="md-form mb-4">
                        <input type="password" id="confirmarContrasena" name="confirmarContrasena" class="form-control validate" placeholder="Confirmar contraseña" value="">
                    </div>
