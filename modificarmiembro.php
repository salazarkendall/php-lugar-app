...
$cedula = $_GET['cedula'];   
    ...
    if(isset($_POST['enviar']))
                {
                    $sql = "Update persona set nombre='".$_POST["nombre"]."', id_permiso='".$_POST["tipoUsuario"]."', apellido1='".$_POST["apellido1"]."',apellido2='".$_POST["apellido2"]."',genero='".$_POST["genero"]."',telefono1='".$_POST["telefono1"]."',telefono2='".$_POST["telefono2"]."',email='".$_POST["email"]."',direccion='".$_POST["direccion"]."',fecha_nacimiento='".$_POST["fecha_nacimiento"]."', comentario_adicional='".$_POST["comentario_adicional"]."' where cedula='".$_POST["cedula"]."'";

                    $result = mysqli_query($conn,$sql);

                    if ($_POST['reiniciarContrasena']='1') {
                        $sql = "Update persona set contrasena='ellugar123' where cedula='".$_POST["cedula"]."'";
...
<body>
    ...
    <?php 
            $conexion=mysqli_connect('localhost','root','root','IglesiaElLugar');
                        $sql="SELECT *,concat(nombre, ' ', apellido1,' ',apellido2) as nombrecompleto from persona where cedula=$cedula";
                        $result=mysqli_query($conexion,$sql);

                        while($mostrar=mysqli_fetch_array($result)){
                            ?>
            <div>
            <form action="modificarmiembro.php" method="POST">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Modificar miembro</h4>
                  </div>
                  <div class="modal-body mx-3">

                    <div class="md-form mb-4">
                        <?php echo "<input type='text' id='cedula' name='cedula' class='form-control validate' placeholder='Número de Cédula' value='".$mostrar['cedula']."' readonly>";?>
                    </div>

                    <div class="md-form mb-4">
                        <h5>Tipo de usuario</h5>
                            <?php  
                                if ($mostrar['id_permiso']==1) {?>
                                        <input type="radio" id="tipoUsuario" name="tipoUsuario" value="1" class="form-control" checked=""><p>Administrador</p>
                                        <input type="radio" id="tipoUsuario" name="tipoUsuario" value="2" class="form-control"><p>Miembro regular</p>
                                <?php }
                                if ($mostrar['id_permiso']==2) {?>
                                         <input type="radio" id="tipoUsuario" name="tipoUsuario" value="1" class="form-control"><p>Administrador</p>
                                        <input type="radio" id="tipoUsuario" name="tipoUsuario" value="2" class="form-control" checked=""><p>Miembro regular</p>
                                <?php }
                            ?>
                    </div>

                    <div class="md-form mb-4">
                      <?php echo "<input type='text' id='nombre' name='nombre' class='form-control validate' placeholder='Nombre' value='".$mostrar['nombre']."'>";?>
                    </div>

                    <div class="md-form mb-4">
                      <?php echo "<input type='text' id='apellido1' name='apellido1' class='form-control validate' placeholder='Primer Apellido' value='".$mostrar['apellido1']."'>";?>
                    </div>

                    <div class="md-form mb-4">
                      <?php echo "<input type='text' id='apellido2' name='apellido2' class='form-control validate' placeholder='Segundo Apellido' value='".$mostrar['apellido2']."'>";?>
                    </div>
                    ...
                    <div class="md-form mb-4">
                        <h5>Género</h5>
                            <?php  
                                if ($mostrar['genero']=='M') {?>
                                        <input type='radio' id='genero' name='genero' value='M' class='form-control' checked><p>Masculino</p>
                                         <input type='radio' id='genero' name='genero' value='F' class='form-control' ><p>Femenino</p>
                                <?php }
                                if ($mostrar['genero']=='F') {?>
                                         <input type='radio' id='genero' name='genero' value='M' class='form-control'><p>Masculino</p>
                    ...
                    <div class="md-form mb-4">
                      <?php echo "<input type='text' id='telefono1' name='telefono1' class='form-control validate' placeholder='telefono1' value='".$mostrar['telefono1']."'>";?>
                    </div>

                    <div class="md-form mb-4">
                      <?php echo "<input type='text' id='telefono2' name='telefono2' class='form-control validate' placeholder='Telefono 2' value='".$mostrar['telefono2']."'>";?>
                    </div>

                    <div class="md-form mb-4">
                      <?php echo "<input type='text' id='email' name='email' class='form-control validate' placeholder='Email' value='".$mostrar['email']."'>";?>
                    </div>

                    <div class="md-form mb-4">
                      <?php echo "<input type='text' id='direccion' name='direccion' class='form-control validate' placeholder='Dirección' value='".$mostrar['direccion']."'>";?>
                    </div>

                    <div class="md-form mb-4">
                        <h5>Fecha de Nacimiento</h5>
                      <?php echo "<input type='date' id='fecha_nacimiento' name='fecha_nacimiento' class='form-control validate' value='".$mostrar['fecha_nacimiento']."'>";?>
                    </div>

                    <div class="md-form mb-4">
                        <h5>Comentario</h5>
                      <?php echo "<input type='text' id='comentario_adicional' name='comentario_adicional' class='form-control validate' placeholder='Comentario adicional' value='".$mostrar['comentario_adicional']."'>";?>
                    </div>
                    <hr>
                    <div class="md-form mb-4">
                      <h6><input type="checkbox" id="reiniciarContrasena"> Reiniciar contraseña</h6><br>
                      <p>La nueva contraseña para el usuario será "ellugar123"</p>
                    </div>
