            ...
            <div class="row about-content justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        <img src="img/bg-img/119.jpg" alt="">
                        <div class="about-text">
                            <h4>Versión</h4>
                            <a href="ayuda-version.php">Ir<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        <img src="img/bg-img/120.jpg" alt="">
                        <div class="about-text">
                            <h4>Manual de Usuario</h4>
                            <a href="ayuda-manualusuario.php">Ir<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        ...
                        <div class="about-text">
                            <h4>Editar perfil</h4>
                            <a href="ayuda-editarperfil.php">Ir<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
