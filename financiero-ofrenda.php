    ...
    if(isset($_POST['enviar']))
                {
                    ...
                    $sql = "INSERT into ofrenda (nombre, monto, moneda, fecha, id_miembro)
                        VALUES ('".$_POST["nombre"]."',".$_POST["monto"].",'".$_POST["moneda"]."','".$_POST["fecha"]."','".$_POST["miembro"]."')";
                    ...
                    echo "<SCRIPT type='text/javascript'> //not showing me this
                            alert('$message');
                    window.location.replace(\"financiero-ofrenda.php\");
                    </SCRIPT>";
                }
        mysqli_close($conn);                       
?>
...
<body>
    ...
    <!-- Insertar Modal -->
            ...
            <form action="financiero-ofrenda.php" method="POST">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Registrar ofrenda</h4>
                  ...
                  <div class="modal-body mx-3">
                    ...
                    <div class="md-form mb-4">
                      <input type="text" id="nombre" name="nombre" class="form-control validate" placeholder="Nombre de ofrenda">
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Ofrendas</h2>
                        <p>Tenga visibilidad de las ofrendas de la iglesia</p>
                    </div>
                    <table class="table table-striped">
                        ...
                        <?php 
                        $sql="SELECT ofrenda.*,concat(persona.nombre, ' ', persona.apellido1,' ',persona.apellido2) as nombrecompleto from ofrenda inner join persona on ofrenda.id_miembro=persona.cedula";
                        $result=mysqli_query($conexion,$sql);
