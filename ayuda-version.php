            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Versión 1.0</h2>
                        <p>Desarrollado en el segundo cuatrimestre del 2019 por Leonardo Aguilar Molina como proyecto de práctica empresarial de la UMCA, bajo la tutoría de Elizabeth Vargas, y teniendo como patrocinador a Alonso Angulo, pastor de la Iglesia El Lugar. </p>
                    </div>
                </div>
            </div>
        </div>
