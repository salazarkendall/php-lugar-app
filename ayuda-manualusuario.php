...
<head>
    ...
    <!-- Title -->
    <title>Iglesia El Lugar | Ayuda</title>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        ...
                        <p>Una guía detallada de cómo usar el sistema. </p>
                        <br>

                        <a href="documentos/IglesiaElLugar-ManualUsuario.pdf" class="btn crose-btn" data-toggle="tooltip" data-placement="top" title="Descargar"><i class="fa fa-cloud-download" aria-hidden="true"></i>Descargar</a>
                    </div>

                    <iframe src="documentos/IglesiaElLugar-ManualUsuario.pdf" width="100%" height="700px">
                        Este navegador no soporta PDFs. Por favor descárguelo: 
                        <a href="documentos/IglesiaElLugar-ManualUsuario.pdf">Descargar PDF</a></iframe>
                </div>
            </div>
        </div>
    </section>
