    ...
    <section class="about-area section-padding-100-0">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Seguridad</h2>
                        <p>Asigne los permisos necesarios</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row about-content justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        ...
                        <div class="about-text">
                            <h4>Aprobar miembros</h4>
                            <a href="seguridad-aprobarmiembros.php">Ir<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-content mb-100">
                        <img src="img/bg-img/118.jpg" alt="">
                        <div class="about-text">
                            <h4>Permisos</h4>
                            <a href="seguridad-permisos.php">Ir<i class="fa fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
