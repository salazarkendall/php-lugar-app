    ...
    if(isset($_POST['enviar']))
                {
                    ...
                    $sql = "INSERT into deuda (acreedor, tasa_interes, monto_inicial, saldo, moneda, fecha_primer_pago, tiempo_deuda, id_miembro, estado)
                        VALUES ('".$_POST["acreedor"]."',".$_POST["tasa_interes"].",".$_POST["monto_inicial"].",".$_POST["monto_inicial"].",'".$_POST["moneda"]."','".$_POST["fecha_primer_pago"]."',".$_POST["tiempo_deuda"].",'".$_POST["miembro"]."','".$_POST["estado"]."')";
                    ...
                    echo "<SCRIPT type='text/javascript'> //not showing me this
                            alert('$message');
                    window.location.replace(\"financiero-deuda.php\");
                    </SCRIPT>";
                }
        mysqli_close($conn);                       
?>
...
<body>
    ...
    <!-- Insertar Modal -->
            ...
            <form action="financiero-deuda.php" method="POST">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Registrar deuda</h4>
                  ...
                  <div class="modal-body mx-3">
                    ...
                    <div class="md-form mb-4">
                      <input type="text" id="acreedor" name="acreedor" class="form-control validate" placeholder="Acreedor">
                    </div>

                    <div class="md-form mb-4">
                      <input type="number" id="tasa_interes" name="tasa_interes" class="form-control validate" placeholder="Tasa de interés">
                    </div>

                    <div class="md-form mb-4">
                      <input type="number" id="monto_inicial" name="monto_inicial" class="form-control validate" placeholder="Monto inicial">
                    </div>
                    ...
                    <div class="md-form mb-4">
                      ...
                      <input type="date" id="fecha_primer_pago" name="fecha_primer_pago" class="form-control validate">
                    </div>

                    <div class="md-form mb-4">
                      <input type="number" id="tiempo_deuda" name="tiempo_deuda" class="form-control validate" placeholder="Cantidad de meses de la deuda">
                    </div>

                     <div class="md-form mb-4">
                        <h5>Estado</h5>
                      <input type="text" id="estado" name="estado" class="form-control validate" value="En progreso" placeholder="Estado" readonly="">
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Deudas</h2>
                        <p>Conozca el estado de las deudas que ha adquirido la iglesia</p>
                    </div>
                    <div class="section-heading">
                        <h4>En progreso</h4>
                    </div>
                    <table class="table table-striped">
                        <tr>
                        	<td><h5>Código</h5></td>
                            <td><h5>Acreedor</h5></td>
                            <td><h5>Tasa de interés<h5></td>
                            <td><h5>Monto inicial<h5></td>
                            <td><h5>Saldo<h5></td>
                            <td><h5>Moneda<h5></td>  
                            <td><h5>Fecha de primer pago<h5></td>
                            <td><h5>Tiempo de la deuda<h5></td> 
                            <td><h5>Tiempo restante<h5></td> 
                            <td><h5>Último miembro en actualizar<h5></td> 
                        </tr>

                        <?php 
                        $sql="SELECT deuda.*,concat(persona.nombre, ' ', persona.apellido1,' ',persona.apellido2) as nombrecompleto, tiempo_deuda- TIMESTAMPDIFF(MONTH, fecha_primer_pago, CURRENT_DATE) AS tiempo_restante from deuda inner join persona on deuda.id_miembro=persona.cedula where deuda.estado='En progreso'";
                        $result=mysqli_query($conexion,$sql);

                        while($mostrar=mysqli_fetch_array($result)){
                        echo "<tr>";
                        echo "<td><p>".$mostrar['id_deuda']."<p></td>";
                        echo "<td><p>".$mostrar['acreedor']."<p></td>";
                        echo "<td><p>".$mostrar['tasa_interes']."<p></td>";
                        echo "<td><p>".number_format($mostrar["monto_inicial"])."<p></td>";
                        echo "<td><p>".number_format($mostrar["saldo"])."<p></td>";
                        echo "<td><p>".$mostrar['moneda']."<p></td>";
                        echo "<td><p>".$mostrar['fecha_primer_pago']."<p></td>";
                        echo "<td><p>".$mostrar['tiempo_deuda']."<p></td>";
                        echo "<td><p>".$mostrar['tiempo_restante']."<p></td>";
                    ...
                    <table class="table table-striped">
                        ...
                        <?php 
                        $sql="SELECT deuda.*,concat(persona.nombre, ' ', persona.apellido1,' ',persona.apellido2) as nombrecompleto, tiempo_deuda- TIMESTAMPDIFF(MONTH, fecha_primer_pago, CURRENT_DATE) AS tiempo_restante from deuda inner join persona on deuda.id_miembro=persona.cedula where deuda.estado='Cancelada'";
                        $result=mysqli_query($conexion,$sql);
