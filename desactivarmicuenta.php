...
$email = $_GET['email']; 
$emailDesactivar = $_POST['emailDesactivar'];
$comentario_adicional = $_POST['comentario_adicional']; 
    ...
    if(isset($_POST['enviar']))
                {
                        $sql = "Update persona set estado='inactivo', id_permiso=3 where email='$emailDesactivar'";

                        $result = mysqli_query($conn,$sql);
                        


                        $message = 'Su cuenta ha sido cerrada satisfactoriamente.';
...
<head>
    ...
    <!-- Title -->
    <title>Iglesia El Lugar | Cerrar mi cuenta</title>
...
<body>
    ...
    <!-- Login form -->
            <div>
            <form action="desactivarmicuenta.php" method="POST">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Cerrar mi cuenta</h4>
                  </div>
                  <div class="modal-body mx-3">
                    <p align="center">Esta acción eliminará su acceso a esta plataforma y su usuario será eliminado de la lista de miembros de la iglesia. En caso de que desee recuperar su cuenta en el futuro deberá contactar a un administrador.</p>

                    <div class="md-form mb-4">
                        <?php echo "<input type='text' id='emailDesactivar' name='emailDesactivar' class='form-control validate' placeholder='Email' value='$email' readonly>";?>
                    </div>

                  </div>
                  <div class="modal-footer d-flex justify-content-center">
                    <input type="submit" name="enviar" value="Confirmar" class="btn crose-btn header-btn"></button>
                  </div>
                </div>
              </div>
              </form>
